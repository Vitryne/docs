...
2. **Manter o protótipo em HTML como fonte** — *perdeu porque:* ele não consome o Design System,
   e quem mantém tela em HTML está escrevendo código que será jogado fora. Além disso, o protótipo em HTML é mais difícil de editar e prototipar novas telas. Em troca, abre-se mão
...
O arquivo original do projeto em HTML no Drive ficam como registro do que veio antes,
